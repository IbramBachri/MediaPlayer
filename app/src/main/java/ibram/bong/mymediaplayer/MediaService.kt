package ibram.bong.mymediaplayer
...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "ibram.bong.mymediaplayer.craete"
        const val ACTION_DESTROY = "ibram.bong.mymediaplayer.destroy"
    ...
    private fun init() {
        ...
        val afd = applicationContext.resources.openRawResourceFd(R.raw.nokia_original_theme)
        try {
